...
export const blogCategories = [
    { name: "All", description: "Includes every category." },
    { name: "Introspection", description: "Thoughts and Emotions." },
    { name: "Insights", description: "Lessons and realizations." },
    { name: "Evolution", description: "Growth and Progess." },
    { name: "Experience", description: "Lived moments." }
];
